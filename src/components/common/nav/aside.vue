        ...
        <span class="el-dropdown-link">
          <i class="iconfont icon-yonghu el-icon-user-solid"></i>用户
                    ...
                    <el-dropdown-menu slot="dropdown">
                        <el-dropdown-item command="require"><i class="iconfont header-icon icon-xiugaimima"></i>修改密码
                        </el-dropdown-item>
                        <el-dropdown-item command="logout"><i class="iconfont icon-zhuxiao header-icon"></i>注销登录
                        </el-dropdown-item>
                    </el-dropdown-menu>
                </el-dropdown>
            </div>
